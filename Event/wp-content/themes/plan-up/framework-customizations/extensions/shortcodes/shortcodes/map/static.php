...
wp_enqueue_script(
	'google-maps-api-v3',
	'https://maps.googleapis.com/maps/api/js?v=3.15&sensor=false&libraries=places&key=AIzaSyDG3tO4-pHuSHLscmtP5meKtnfVUgaHnbM&language=' . $language,
	array(),
	'3.15',
	true
);
wp_enqueue_script(
	'ht-fw-shortcode-map-script',
