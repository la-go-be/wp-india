<?php
/**
 * Add font ionicon to icon option
 * @param $sets
 * @return mixed
 */
function _filter_theme_new_icon_set($sets) {
    $sets['ionicon'] = array(
        'font-style-src' => get_template_directory_uri().'/css/ionicons.min.css',
        'container-class' => 'fa-lg', // some fonts need special wrapper class to display properly
        'groups' => array(
            'web-app' => esc_html__('Web Application Icons', 'plan-up'),
            'ion-icon' => esc_html__('Ion Icons', 'plan-up'),
            'transport' => esc_html__('Transportation Icons', 'plan-up'),
            'gender' => esc_html__('Gender Icons', 'plan-up'),
            'file' => esc_html__('File Type Icons', 'plan-up'),
            // 'spinner' => esc_html__('Spinner Icons', 'plan-up'),
            'form' => esc_html__('Form Control Icons', 'plan-up'),
            'payment' => esc_html__('Payment Icons', 'plan-up'),
            'chart' => esc_html__('Chart Icons', 'plan-up'),
            'currency' => esc_html__('Currency Icons', 'plan-up'),
            'text' => esc_html__('Text Editor Icons', 'plan-up'),
            'direction' => esc_html__('Directional Icons', 'plan-up'),
            'video' => esc_html__('Video Player Icons', 'plan-up'),
            'brand' => esc_html__('Brand Icons', 'plan-up'),
            'medical' => esc_html__('Medical Icons', 'plan-up'),
        ),
        'icons' => array(
            // Ion Icons
