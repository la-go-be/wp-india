...
.fw-col-sm-8 .tl2:nth-child(3){
display:none;
}

div#nav-holder ul li:nth-child(3), div#nav-holder ul li:nth-child(4) {
    display: none;
}

#events .we-table .tb-meta:nth-child(3){
display:none;
}

.single-product .we-icl-import, .single-product .woo-event-schedu{
display:none;
}
...
<script type="text/javascript">
 ...
 jQuery(document).ready(function(){
		...
		if(jQuery('.part-name-wrapper input[type="text"]').hasClass('ab'))
		{
		jQuery('.ab').each
		  (
		  	function(index, elem)
	...
	jQuery('#billing_phone, #billing_postcode').keyup(function () { 
