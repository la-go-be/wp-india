...
if ( $products->have_posts() ) : ?>
	...
	<div class="related products">
		...
		<h2><?php if($we_main_purpose=='woo'){ _e( 'Related Products', 'woocommerce' );}else{ echo get_option('we_text_related')!='' ? get_option('we_text_related') : esc_html__( 'Related Events', 'exthemes' ); } ?></h2>
