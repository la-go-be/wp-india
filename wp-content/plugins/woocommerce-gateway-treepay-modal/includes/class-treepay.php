...
class Treepay {
    ...
    /**
     * Treepay_Loader    $loader    Maintains and registers all hooks for the plugin.
     */
    protected $loader;
     ...
     *
     * - Treepay_Loader. Orchestrates the hooks of the plugin.
     * - Treepay_i18n. Defines internationalization functionality.
     * - Treepay_Admin. Defines all hooks for the admin area.
     * - Treepay_Public. Defines all hooks for the public side of the site.
     *
    ...
    private function load_dependencies() {
        ...
        $this->loader = new Treepay_Loader();
    }

    /**
     * Define the locale for this plugin for internationalization.
     *
     * Uses the Treepay_i18n class in order to set the domain and to register the hook
     * with WordPress.
     *
     * @since    1.0.0
     * @access   private
    ...
    private function define_admin_hooks() {
        ...
        $plugin_admin = new Treepay_Admin($this->get_plugin_name(), $this->get_version());
     ...
     *
     * @since     1.0.0
     * @return    Treepay_Loader    Orchestrates the hooks of the plugin.
     */
