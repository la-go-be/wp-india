    ...
    <form method="post" action="admin-post.php">
        ...
        <table class="wp-list-table widefat fixed woocommerce_page_warranty_requests" cellspacing="0">
            ...
            while ($products->have_posts()):
                ...
                $_product   = WC_Warranty_Compatibility::wc_get_product(get_the_ID());
                $warranty   = warranty_get_product_warranty( $_product->id );
                ...
                <tr id="row_<?php echo $_product->id; ?>" data-id="<?php echo $_product->id; ?>">
                    <th scope="row" class="check-column">
                        ...
                        <input id="cb-select-<?php echo $_product->id; ?>" class="cb" type="checkbox" name="post[]" value="<?php echo $_product->id; ?>" />
                        <?php endif; ?>
                    </th>
                    ...
                    <td>
                        <strong><a class="editinline" data-target="edit_<?php echo $_product->id; ?>" href="#"><?php echo $_product->get_title(); ?></a></strong>
                        <div class="row-actions">
                            <span class="inline hide-if-no-js"><a class="editinline" data-target="edit_<?php echo $_product->id; ?>" href="#"><?php _e('Edit', 'wc_warranty'); ?></a></span>
                        </div>
                    </td>
                    <td>
                    ...
                    <td>
                        <?php
                        if ( ! $terms = get_the_terms( $_product->id, 'product_cat' ) ) {
                    ...
                    <td class="warranty_string"><?php echo warranty_get_warranty_string( $_product->id ); ?></td>
                </tr>

                <?php if ( $_product->product_type != 'variable' ): ?>
                <tr id="edit_<?php echo $_product->id; ?>" data-id="<?php echo $_product->id; ?>" class="inline-edit-row inline-edit-row-post inline-edit-product quick-edit-row quick-edit-row-post inline-edit-product alternate inline-editor">
                    <td class="colspanchange" colspan="7">
                            ...
                            <div class="inline-edit-col">
                                ...
                                <div class="inline-edit-group">
                                    <label class="alignleft">
                                        <input type="checkbox" name="warranty_default[<?php echo $_product->id; ?>]" data-id="<?php echo $_product->id; ?>" <?php checked(true, $default); ?> class="default_toggle" value="yes" />
                                ...
                                <label class="alignleft">
                                    ...
                                    <span class="input-text-wrap">
                                        <select name="warranty_type[<?php echo $_product->id; ?>]" class="warranty-type warranty_<?php echo $_product->id; ?>" id="warranty_type_<?php echo $_product->id; ?>" data-id="<?php echo $_product->id; ?>">
                                ...
                                <label class="alignleft show_if_included_warranty show_if_addon_warranty">
                                    ...
                                    <span class="input-text-wrap">
                                        <input type="text" name="warranty_label[<?php echo $_product->id; ?>]" value="<?php echo esc_attr($label); ?>" class="input-text sized warranty-label warranty_<?php echo $_product->id; ?>" id="warranty_label_<?php echo $_product->id; ?>">
                                    </span>
                                </label>
                                <br class="clear" />
                                ...
                                <label class="alignleft included-form">
                                    ...
                                    <span class="input-text-wrap">
                                        <select name="included_warranty_length[<?php echo $_product->id; ?>]" class="select short included-warranty-length warranty_<?php echo $_product->id; ?>" id="included_warranty_length_<?php echo $_product->id; ?>">
                                ...
                                <div class="inline-edit-group included-form" id="limited_warranty_row_<?php echo $_product->id; ?>">
                                    <label class="alignleft">
                                        <span class="title"><?php _e('Length', 'wc_warranty'); ?></span>
                                        <span class="input-text-wrap">
                                            <input type="text" class="input-text sized warranty_<?php echo $_product->id; ?>" size="3" name="limited_warranty_length_value[<?php echo $_product->id; ?>]" value="<?php if ($warranty['type'] == 'included_warranty') echo $warranty['value']; ?>" style="width: 50px;">
                                        </span>
                                    </label>

                                    <label class="alignleft">
                                        <select name="limited_warranty_length_duration[<?php echo $_product->id; ?>]" class="warranty_<?php echo $_product->id; ?>" style="vertical-align: baseline;">
                        ...
                        <fieldset class="inline-edit-col-left">
                            <div class="inline-edit-col addon-form">
                                ...
                                <div class="inline-edit-group">
                                    <label class="alignleft">
                                        <input type="checkbox" name="addon_no_warranty[<?php echo $_product->id; ?>]" id="addon_no_warranty" value="yes" <?php if (isset($warranty['no_warranty_option']) && $warranty['no_warranty_option'] == 'yes') echo 'checked'; ?> class="checkbox warranty_<?php echo $_product->id; ?>" />
                                        ...
                                        <?php if ( isset($warranty['addons']) ) foreach ( $warranty['addons'] as $addon ): ?>
                                            <tr>
                                                <td valign="middle">
                                                    ...
                                                    <input type="text" name="addon_warranty_amount[<?php echo $_product->id; ?>][]" class="input-text sized warranty_<?php echo $_product->id; ?>" size="2" value="<?php echo esc_attr($addon['amount']); ?>" />
                                                </td>
                                                <td valign="middle">
                                                    <input type="text" class="input-text sized warranty_<?php echo $_product->id; ?>" size="2" name="addon_warranty_length_value[<?php echo $_product->id; ?>][]" value="<?php if ($warranty['type'] == 'addon_warranty') echo esc_attr($addon['value']); ?>" />
                                                    <select name="addon_warranty_length_duration[<?php echo $_product->id; ?>][]" class="warranty_<?php echo $_product->id; ?>">
                        ...
                        <p class="submit inline-edit-save">
                            <a class="button-secondary alignleft editinline" data-target="edit_<?php echo $_product->id; ?>" href="#"><?php _e('Close', 'wc_warranty'); ?></a>
                ...
                if ($_product->product_type == 'variable'):
                    foreach ($_product->get_children() as $child):
                        $_variation = WC_Warranty_Compatibility::wc_get_product($child);
                        ...
                        <tr id="row_<?php echo $child; ?>" data-id="<?php echo $child; ?>">
                            <th scope="row" class="check-column">
                                <input id="cb-select-<?php echo $_variation->variation_id; ?>" type="checkbox" class="cb" name="post[]" value="<?php echo $child; ?>" />
                            </th>
                            <td><?php echo $_variation->variation_id; ?></td>
                            <td class="thumb column-thumb">
                                <a href="post.php?post=<?php echo $_variation->id; ?>&action=edit">
                            ...
                            <td>
                                <?php
                                if ( ! $terms = get_the_terms( $_variation->id, 'product_cat' ) ) {
                                    echo '<span class="na">&ndash;</span>';
                                } else {
                                    $termlist = array();
                                    foreach ( $terms as $term ) {
        ...
        <div class="tablenav">
            ...
            <div class="alignleft" style="line-height: 30px;">
                ...
                <span class="pagination-links">
                    <a href="<?php echo esc_url( add_query_arg('per_page', 10, 'admin.php?page=warranty_requests&tab=manage') ); ?>" <?php if ($per_page == 10) echo 'class="current"'; ?>>10</a> |
                    <a href="<?php echo esc_url( add_query_arg('per_page', 25, 'admin.php?page=warranty_requests&tab=manage') ); ?>" <?php if ($per_page == 25) echo 'class="current"'; ?>>25</a> |
                    <a href="<?php echo esc_url( add_query_arg('per_page', 50, 'admin.php?page=warranty_requests&tab=manage') ); ?>" <?php if ($per_page == 50) echo 'class="current"'; ?>>50</a> |
                    <a href="<?php echo esc_url( add_query_arg('per_page', 100, 'admin.php?page=warranty_requests&tab=manage') ); ?>" <?php if ($per_page == 100) echo 'class="current"'; ?>>100</a>
                </span>
            </div>
        </div>
    </form>
