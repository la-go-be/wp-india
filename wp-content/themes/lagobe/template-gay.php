...
template name: Gay Page(Homepage)
...
$enabled = $redux_demo['switch-on'];

$banner_1_img = $redux_demo['banner-1-img'];
...
$banner_1_title = $redux_demo['banner-1-title'];

$banner_1_subtitle = $redux_demo['banner-1-subtitle'];

$banner_1_shortdesc = $redux_demo['banner-1-shortdesc'];

$banner_1_btn_txt = $redux_demo['banner-1-btn-txt'];

$banner_1_btn_url = $redux_demo['banner-1-btn-url'];



$banner_2_title = $redux_demo['banner-2-title'];

$banner_2_subtitle = $redux_demo['banner-2-subtitle'];

$banner_2_shortdesc = $redux_demo['banner-2-shortdesc'];

$banner_2_btn_txt = $redux_demo['banner-2-btn-txt'];

$banner_2_btn_url = $redux_demo['banner-2-btn-url'];
				...
				<div class="right-sec">
					...
					<div class="right-bottom-sec">
						...
						<div class="desc">
							...
							<a href="<?php echo $banner_2_btn_url; ?>" class="btn"><?php echo $banner_2_btn_txt; ?></a>
									...
									<div class="grid">
											...
											<div class="category-area">
												...
												<div class="cat-title">
												 ...
												 <a href="<?php echo site_url(); ?>/product-category/man/" class="btn"><?php echo $cat_sec_btn_txt_en; ?></a>
										    ...
										    $parent_terms = get_terms($taxonomyName, array('parent' => 47, 'childless' => false, 'orderby' => 'slug', 'hide_empty' => false));
											...
											<div class="collection-area">
												...
												<a href="<?php echo site_url(); ?>/collections/man/" class="btn"><?php echo $col_sec_btn_txt_en; ?></a>
												...
												<div class="categories">
													...
													?>
														...
														<li><a href="<?php echo esc_url( get_term_link( $term, $term->taxonomy ) ); ?>">
															...
															<?php $texo_catd = get_term_meta($term->term_id, '_cmb2_man_img', true); 
											...
											<div class="sellers-area">
												...
												<a href="<?php echo site_url(); ?>/shop-man" class="btn"><?php echo $sel_sec_btn_txt_en; ?></a>
