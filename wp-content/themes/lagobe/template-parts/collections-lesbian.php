<?php 
/*
template name: Collections Lesbian
*/
get_header();
    ...
    <div class=" archive-header loop-meta  grid-span-12" itemscope="itemscope" itemtype="http://schema.org/WebPageElement">
      ...
      <div class="title-sec">
        <h2>
          <?php the_title(); ?>
          .</h2>
        <a href="<?php echo $redux_demo['col_page_woman_url']; ?>" class="btn"><?php echo $col_sec_btn_txt_en; ?></a> </div>
    </div>
    <!-- .loop-meta -->
  </div>
</div>
<div class="collection-area">
  <div class="cat-title">
    ...
    <span><?php echo $col_sec_subtitle_en; ?></span> </div>
  	<a href="<?php echo $redux_demo['col_page_woman_url']; ?>" class="btn"><?php echo $col_sec_btn_txt_en; ?></a>
  <div class="categories">
    ...
    <ul class='row'>
      <?php 
			...
			?>
      <li><a href="<?php echo esc_url( get_term_link( $term, $term->taxonomy ) ); ?>"> <span><?php echo $term->name; ?></span>
        <?php if($counter % 2 == 0) { ?>
