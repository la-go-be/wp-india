...
function st_options_form() {
  $plugin_location= get_template_directory_uri().'/inc/share-this/';
...
function st_add_frontend_stylesheet() {
		 wp_enqueue_style( 'st-widget', get_template_directory_uri() . '/inc/share-this/css/style.css',false);
}
...
/* <![CDATA[ */
var st_script_vars = {"plugin_url":"'.get_template_directory_uri().'/inc/share-this/"};
/* ]]> */
</script>';
