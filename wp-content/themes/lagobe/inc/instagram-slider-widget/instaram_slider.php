...
class JR_InstagramSlider extends WP_Widget {
	...
	//wp_enqueue_style( 'instag-slider', get_template_directory_uri() . '/inc/instagram-slider-widget/assets/css/instag-slider.css', array(), self::VERSION );
	wp_enqueue_script( 'jquery-pllexi-slider', get_template_directory_uri() . '/inc/instagram-slider-widget/assets/js/jquery.flexslider-min.js', array( 'jquery' ), '2.2', false );
	}
	...
	public function admin_enqueue( $hook ) {
		...
		wp_enqueue_style( 'jr-insta-admin-styles', get_template_directory_uri() . '/inc/instagram-slider-widget/assets/css/jr-insta-admin.css', array(), self::VERSION );
		wp_enqueue_script( 'jr-insta-admin-script', get_template_directory_uri() . '/inc/instagram-slider-widget/assets/js/jr-insta-admin.js', array( 'jquery' ), self::VERSION, true );
	}
