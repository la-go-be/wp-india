...
function taxonomy_image_plugin_css_admin() {
	...
	wp_enqueue_style('taxonomy-image-plugin-edit-tags',get_template_directory_uri() . '/inc/taxonomy-images/css/admin.css',array(),taxonomy_image_plugin_version(),'screen');
}
...
function taxonomy_image_plugin_css_public() {
	...
	wp_enqueue_style('taxonomy-image-plugin-public',get_template_directory_uri() . '/inc/taxonomy-images/css/style.css',array(),taxonomy_image_plugin_version(),'screen');
}
