...
function wac_cart_table() {
    // enqueue style
    wp_enqueue_style('wooajaxcart',  get_template_directory_uri() . '/inc/woocommerce-ajax-cart/wooajaxcart.css', WAC_PLUGIN);

    // enqueue js
    wp_enqueue_script('wooajaxcart', get_template_directory_uri() . '/inc/woocommerce-ajax-cart/wooajaxcart.js', WAC_PLUGIN);
